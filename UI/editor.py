...
def open_image():
    ...
    canny_th2_slider.set(DEFAULT_CANNY_TH2)
    ...
    h_min.set(DEFALUT_LOWER_H)
    s_min.set(DEFALUT_LOWER_S)
    v_min.set(DEFALUT_LOWER_V)
    h_max.set(DEFALUT_UPPER_H)
    s_max.set(DEFALUT_UPPER_S)
    v_max.set(DEFALUT_UPPER_V)
...
def save_image():
    ...
    try:
        img_to_save = image_to_pil(preview_image)
...
def update_preview(event=None):
    ...
    img = imglib.translate_image(
        img,
        int(x_translation_slider.get()),
        int(y_translation_slider.get())
    )
...
width_reset_button = tk.Button(frame_cut, text="Default", command=lambda: width_slider.set(int(width_slider.cget("to"))))
...
height_reset_button = tk.Button(frame_cut, text="Default", command=lambda: height_slider.set(int(height_slider.cget("to"))))
height_reset_button.pack(fill="x", pady=2)
...
zoom_default_button = tk.Button(frame_zoom, text="Default", command=lambda: zoom_slider.set(DEFAULT_ZOOM))
zoom_default_button.pack(fill="x", pady=2)
...
binarize_reset_button = tk.Button(frame_binarize, text="Default", command=lambda: binarize_slider.set(DEFAULT_BINARIZE_THRESHOLD))
binarize_reset_button.pack(fill="x", pady=2)
...
resolution_slider_reset_button = tk.Button(frame_resolution, text="Default", command=lambda: resolution_slider.set(DEFAULT_RESOLUTION_SCALE))
resolution_slider_reset_button.pack(fill="x", pady=2)
...
alpha_slider_default_button = tk.Button(frame_fusion, text="Default", command=lambda: alpha_slider.set(DEFAULT_ALPHA))
alpha_slider_default_button.pack(fill="x", pady=2)
...
h_min.pack(fill="x")
h_min_default_button = tk.Button(frame_hsv, text="Default", command=lambda: h_min.set(DEFALUT_LOWER_H))
h_min_default_button.pack(fill="x", pady=2)

s_min = tk.Scale(frame_hsv, from_=0, to=255, orient="horizontal", command=update_preview)
s_min.pack(fill="x")
s_min_default_button = tk.Button(frame_hsv, text="Default", command=lambda: s_min.set(DEFALUT_LOWER_S))
s_min_default_button.pack(fill="x", pady=2)

v_min = tk.Scale(frame_hsv, from_=0, to=255, orient="horizontal", command=update_preview)
v_min.pack(fill="x")
v_min_default_button = tk.Button(frame_hsv, text="Default", command=lambda: v_min.set(DEFALUT_LOWER_V))
v_min_default_button.pack(fill="x", pady=2)

tk.Label(frame_hsv, text="Upper").pack()
h_max = tk.Scale(frame_hsv, from_=0, to=179, orient="horizontal", command=update_preview)
h_max.set(179)
h_max.pack(fill="x")
h_max_default_button = tk.Button(frame_hsv, text="Default", command=lambda: h_max.set(DEFALUT_UPPER_H))
h_max_default_button.pack(fill="x", pady=2)

s_max = tk.Scale(frame_hsv, from_=0, to=255, orient="horizontal", command=update_preview)
s_max.set(255)
s_max.pack(fill="x")
s_max_default_button = tk.Button(frame_hsv, text="Default", command=lambda: s_max.set(DEFALUT_UPPER_S))
s_max_default_button.pack(fill="x", pady=2)

v_max = tk.Scale(frame_hsv, from_=0, to=255, orient="horizontal", command=update_preview)
v_max.set(255)
v_max.pack(fill="x")
v_max_default_button = tk.Button(frame_hsv, text="Default", command=lambda: v_max.set(DEFALUT_UPPER_V))
v_max_default_button.pack(fill="x", pady=2)
...
canny_th1_default_button = tk.Button(canny_frame, text="Default", command=lambda: canny_th1_slider.set(DEFAULT_CANNY_TH1))
canny_th1_default_button.pack(fill="x", pady=2)
...
canny_th2_default_button = tk.Button(canny_frame, text="Default", command=lambda: canny_th2_slider.set(DEFAULT_CANNY_TH2))
canny_th2_default_button.pack(fill="x", pady=2)
...
sobel_th_default_button = tk.Button(sobel_frame, text="Default", command=lambda: sobel_th_slider.set(DEFAULT_SOBEL_TH))
sobel_th_default_button.pack(fill="x", pady=2)
